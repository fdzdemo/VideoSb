...
<!--<base href="http://localhost:8080/Voids/">--><base href=".">
    ...
    <link rel="stylesheet" href="/VideoSb/static/z/profile.css">
    <link rel="icon" href="http://localhost:8080/VideoSb/static/z/favicon.png" type="image/png">
...
<header>
	<div class="container top_bar clearfix">
		<img src="/VideoSb/static/z/logo.png" alt="智游">
		<div id="tele">
	...
	<menu>
		<div class="container clearfix">
			...
			<div id="user_bar">
				...
				<a  id="lay_out" href="/VideoSb/loginOut.do">退出</a>
			</div>
		</div>
	</menu>
</header>
                ...
                <div class="proflle_tab_body">
                    ...
                    <div class="proflle_tab_workplace clearfix">
                        ...
                        <ul class="profile_ifo_area">
                            ...
                            <li><span class="dd">性　别：</span>${user.sex}
    ...
    <footer>
        <div class="container">
            <ul>
                <li><img src="/VideoSb/static/z/footer_logo.png" alt="" id="foot_logo"></li>
